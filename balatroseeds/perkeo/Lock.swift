...
class Lock {
    ...
    func initLocks(_ ante: Int, _ freshProfile: Bool, _ freshRun: Bool) {
        ...
        if freshProfile {
            ...
            lock(CommonJoker.Shoot_the_Moon)
            ...
            lock(UnCommonJoker.Astronomer)
            lock(UnCommonJoker.Bootstraps)
            
            lock(UnCommonJoker.Cartomancer)
            lock(UnCommonJoker.Flower_Pot)
            lock(UnCommonJoker.Matador)
